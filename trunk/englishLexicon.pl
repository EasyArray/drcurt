...
lexEntry(pn,[symbol:fever,syntax:[fever],num:pl,per:thr]).
lexEntry(pn,[symbol:eyes,syntax:[eyes],num:pl,per:the]).
...
lexEntry(pn,[symbol:incontinence,syntax:[incontinence],num:pl,per:thr]). 
